        ...
        <div class="mt-8 space-y-4">
            <!-- Card Header -->
             <div class="bg-white shadow rounded-lg p-4">
                ...
                <p>Menambah siswa ke dalam sistem</p>
             </div>
             <!-- Card Header End -->
             ...
             <!-- Card Content Start-->
              <div class="bg-white shadow rounded-lg">
                <form action="" class="p-4 grid grid-cols-2 gap-4">
                    ...
                    <div class="flex justify-end gep-4 col-span-2">
            <a href="/students" class="py-2 px-4 bg-gray-100 rounded-lg"><b>Kembali</b></a>
            <button type="submit" class="py-2 px-4 bg-blue-500 rounded-lg text-white"><b>Simpan</b></button>
            </div> 
                </form>
              </div>
            <!-- Card Content End-->
